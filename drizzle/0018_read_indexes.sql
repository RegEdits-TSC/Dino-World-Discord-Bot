CREATE INDEX `attractions_user` ON `attractions` (`user_id`);--> statement-breakpoint
...
CREATE INDEX `expeditions_user_claimed` ON `expeditions` (`user_id`,`claimed_at_ms`);--> statement-breakpoint
CREATE INDEX `lots_user` ON `lots` (`user_id`);--> statement-breakpoint
CREATE INDEX `season_progress_season_user` ON `season_progress` (`season_index`,`user_id`);--> statement-breakpoint
